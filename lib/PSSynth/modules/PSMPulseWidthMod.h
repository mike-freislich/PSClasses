...
class PSMPulseWidthMod : public PSModule
{
public:
    PSMPulseWidthMod() : PSModule() { typeName = "PSMPulseWidthMod"; }
    ...
    {
        PSMPulseWidthMod *newMod = PSModule::create<PSMPulseWidthMod>(key, displayName);
        newMod
...
protected:
    PSParameter *_freq, *_gain, *_shape;
    AudioAmplifier *_amp;
